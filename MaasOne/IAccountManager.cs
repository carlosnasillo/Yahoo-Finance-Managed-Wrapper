...
namespace MaasOne
{
    ...
    {
        event AsyncIAccountManagerDownloadCompletedEventHandler LoggedStatusChanged;    


        void LogInAsync(System.Net.NetworkCredential user, object userArgs);
        void LogOutAsync(object userArgs);
